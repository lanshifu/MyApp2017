...
public class PopMenu {
    ...
    private List<PoPItem> mMenuItems = new ArrayList<>();
    ...
    private void buildAnimateGridLayout() {
        ...
        for (int i = 0; i < mMenuItems.size(); i++) {
            ...
            PopItemView subView = new PopItemView(mActivity);
            PoPItem menuItem = mMenuItems.get(i);
    ...
    public static class Builder {
        ...
        public Builder addMenuItem(PoPItem menuItem) {
        ...
        public Builder setOnPopMenuItemListener(PopMenuItemListener listener) {
