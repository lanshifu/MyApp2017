...
public class PopItemView extends LinearLayout {
    ...
    public PopItemView(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        scaleViewAnimation(PopItemView.this, factor);
                        break;
                    case MotionEvent.ACTION_UP:
                        scaleViewAnimation(PopItemView.this, 1);
                        break;
                }
                return false;
            }
     ...
     * @param popMenuItem
     */
    public void setPopMenuItem(PoPItem popMenuItem) {
